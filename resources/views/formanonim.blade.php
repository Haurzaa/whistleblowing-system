...
<html lang="id">
  <head>
    ...
    <title>Form Pengungkapan Anonim</title>
  ...
  <body>
    ...
    <div class="container mt-5">
      <h2 class="judul-form mb-4 text-center">Form Pengungkapan Anonim</h2>

      <form action="{{ route('form.anonim.store') }}" method="POST" enctype="multipart/form-data" class="shadow p-4 rounded bg-light">
    @csrf
